...
def main():
    ...
    model = joblib.load("models/all-rf/rf_model.pkl")
    scaler = joblib.load("models/all-rf/rf_scaler.pkl")
    encoder = joblib.load("models/all-rf/rf_label_encoder.pkl")

    y_enc = encoder.transform(y)

    print("Performing speaker-independent split (GroupShuffleSplit)...")
